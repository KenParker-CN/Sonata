                ...
                {hasTrack ? <>
                            ...
                            >
                                ...
                                >
                                    {track?.cover ? (
                                        ...
                                        <div
                                            className="flex h-12 w-12 items-center justify-center rounded-lg bg-player-border text-player-muted shadow-lg">
                                            <Play size={14}/>
                                        </div>
                                    )}
                                </button>
                    ...
                    <div className="flex items-center gap-0.5 sm:gap-2 shrink-0">
                        ...
                        >
                            ...
                            {queueCount > 0 && (
                                <span
                                    className="absolute -right-0.5 -top-0.5 flex h-3.5 min-w-3.5 items-center justify-center rounded-full bg-player-accent px-1 text-[9px] font-bold text-player">
              {queueCount}
            </span>
                            )}
                        </button>
